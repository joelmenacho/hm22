...
// Featured home
import hogar from '../../components/Featured-home/data/data.js';
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Responsive, clean and open source home delivery app using Next.js & Tailwind CSS." />
      ...
      <div className="p-3 max-w-7xl m-auto">
        ...
        <div>
            ...
            <div className="my-12 grid place-items-center grid-cols-1 gap-4 md:grid-cols-3 sm:grid-cols-2">
                {
                    hogar ? 
                    hogar.map((home, index) =>
                        <div key={index} className="card relative bg-gray-200 rounded-xl overflow-hidden shadow-slate-900" title={home.title}>
                        ...
                        <Link href={`/${home.route}`}>
                            ...
                            <div className="relative">
                                <img src={home.image_url} alt="home-Image" max-height="200px" width="100%" className="meal-img ease-in-out duration-300" />
                                ...
                                <p className="text-sm text-gray-400 mb-2">{home.description}</p>
                                <span className="text-xl text-yellow-600 flex items-center gap-1">
                                {
                                    Array.from({ length: home.rating }).map((_, index) => (
                                    <MdStar key={index}/>
                                    ))
                                }
                                </span>
            ...
            <div className="my-12 grid place-items-center grid-cols-1 gap-4 md:grid-cols-2">
                {
                    ...
                    menus.map((menu, index) =>
                        ...
                        <Link href="">
                            <a>
                            <div className="relative">
                                <img src={menu.image_url} alt="home-Image" max-height="400px" width="100%" className="meal-img ease-in-out duration-300" />
