...
// hogar Data
import hogar from '../components/Featured/data/data.js';
...
export default function Product() {
    ...
    return (
        ...
        <Head>
            <title>
                {hogar.map((home) => product_query.route == home.route ? `${home.title} - HM` : null)}
            </title>
            ...
            <div className="mt-6 sm:mt-10">
                {
                    hogar.map((home, index) => 
                        <div key={index}>
                            {
                                product_query.route == home.route ?
                                    <div className="grid gird-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-6 h-max">
                                        <div className="overflow-hidden rounded-xl">
                                            <img src={home.image_url} alt="Product-Image" className=" w-full"/>
                                        </div>
            ...
            <div className="mt-10 grid place-items-center grid-cols-1 gap-4 md:grid-cols-3 sm:grid-cols-2">
                {
                    hogar.map((home, index) =>
                        product_query.route != home.route ?
                            <div key={index} className="card relative bg-gray-50 rounded-xl overflow-hidden shadow-slate-900" title={home.title}>
                                ...
                                <Link href={`/${home.route}`}>
                                    ...
                                    <div className="relative">
                                        ...
                                        <h3 className="flex justify-between items-center text-xl font-semibold mb-1 text-white">
                                            ...
                                            <span>S/{home.price}</span>
                                        </h3>
                                        <p className="text-sm text-gray-50 mb-2">{home.description}</p>
